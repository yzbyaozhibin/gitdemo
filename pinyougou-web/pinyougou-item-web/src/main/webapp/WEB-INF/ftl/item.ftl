    ...
    <div id="item">
        ...
        <div class="product-info">
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
							<span class="jqzoom">
								<#if (imgList?size > 0)>
								<img jqimg="${imgList[0].url}" src="${imgList[0].url}" width="400px" height="400px"/>
                                </#if>
                            </span>
                    </div>
                    <!--下方的缩略图-->
            ...
            <div class="fr itemInfo-wrap">
                ...
                <#assign optionList = goodsDesc.specificationItems?eval/>
                <div class="clearfix choose">
                    <div id="specification" class="summary-wrap clearfix">
                        ...
                        <dl>
                            ...
                            <#list option.attributeValue as value>
                            <dd>
                                <a href="javascript:;" class="{{spec['${option.attributeName}'] == '${value}'?'selected':''}}"
                                   ng-click="setSpec('${option.attributeName}','${value}')">
                                    ${value}<span title="点击取消选择">&nbsp;</span>
                                </a>
                            </dd>
                            </#list>
                        </dl>
                        ...
                        <div class="summary-wrap">
                            <div class="fl title">
                                <div class="control-group">
                                    <div class="controls">
                                        <input ng-model="num" type="text" class="itxt"/>
